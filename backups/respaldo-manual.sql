...
SELECT pg_catalog.setval('public.accionmedicamentos_catmed_pk_seq', 16, true);
...
SELECT pg_catalog.setval('public."medicamentoSintoma_medicaSintoma_seq"', 7, true);
...
SELECT pg_catalog.setval('public.medicamento_medicamento_pk_seq', 10, true);
...
SELECT pg_catalog.setval('public.sintomas_sintoma_pk_seq', 13, true);
